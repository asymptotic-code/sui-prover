...
-- ============================================================================
-- Homogeneous bitwise operator instances for all UInt types (up to UInt64)
...
-- ============================================================================
-- Bitwise operations for BoundedNat (u128, u256)
-- ============================================================================

instance : AndOp (BoundedNat n) := ⟨BoundedNat.land⟩
instance : OrOp (BoundedNat n) := ⟨BoundedNat.lor⟩
instance : XorOp (BoundedNat n) := ⟨BoundedNat.xor⟩

instance : HShiftLeft (BoundedNat n) UInt8 (BoundedNat n) := ⟨fun a b =>
  BoundedNat.shiftLeft a b.toNat⟩

instance : HShiftRight (BoundedNat n) UInt8 (BoundedNat n) := ⟨fun a b =>
  BoundedNat.shiftRight a b.toNat⟩
