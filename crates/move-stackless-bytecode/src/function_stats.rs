...
use move_binary_format::file_format::{FunctionHandleIndex, Visibility};
use move_compiler::{
...
pub struct PackageTargets {
    ...
    pub abort_check_functions: BTreeSet<QualifiedId<FunId>>,
    pub skipped_specs: BTreeMap<QualifiedId<FunId>, String>,
    pub ignore_aborts: BTreeSet<QualifiedId<FunId>>,
    pub omit_opaque_specs: BTreeSet<QualifiedId<FunId>>,
    focus_specs: BTreeSet<QualifiedId<FunId>>,
    pub scenario_specs: BTreeSet<QualifiedId<FunId>>,
    pub spec_boogie_options: BTreeMap<QualifiedId<FunId>, String>,
    pub spec_timeouts: BTreeMap<QualifiedId<FunId>, u64>,
    pub loop_invariants: BTreeMap<QualifiedId<FunId>, BiBTreeMap<QualifiedId<FunId>, usize>>,
