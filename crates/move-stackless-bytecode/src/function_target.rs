...
pub struct FunctionData {
    ...
    pub modify_targets: BTreeMap<QualifiedId<DatatypeId>, Vec<Exp>>,
...
impl<'env> FunctionTarget<'env> {
    ...
    /// property
    pub fn is_pragma_true(&self, _name: &str, _default: impl FnOnce() -> bool) -> bool {
    ...
    pub fn get_modify_targets_for_type(&self, ty: &QualifiedId<DatatypeId>) -> Option<&Vec<Exp>> {
        self.get_modify_targets().get(ty)
    }

    /// Gets all modify targets
    pub fn get_modify_targets(&self) -> &BTreeMap<QualifiedId<DatatypeId>, Vec<Exp>> {
        &self.data.modify_targets
    }

    /// Get all modifies targets, as instantiated struct ids.
    pub fn get_modify_ids(&self) -> BTreeSet<QualifiedInstId<DatatypeId>> {
        self.data
            .modify_targets
            .iter()
            .flat_map(|(qid, exps)| {
    ...
    pub fn get_modify_ids_and_exps(&self) -> BTreeMap<QualifiedInstId<DatatypeId>, Vec<&Exp>> {
