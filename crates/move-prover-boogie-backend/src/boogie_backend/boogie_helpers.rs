...
pub fn boogie_struct_name_bv(struct_env: &StructEnv<'_>, inst: &[Type], _bv_flag: bool) -> String {
...
pub fn boogie_field_sel(field_env: &FieldEnv<'_>, _inst: &[Type]) -> String {
...
pub fn boogie_modifies_memory_name(
    env: &GlobalEnv,
